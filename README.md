...
A full-stack AI-powered notes application by Aditya, built for the Peblo Full Stack Developer Challenge. The idea was to build something that feels like an actual product — not just a CRUD app with an AI button slapped on it.
